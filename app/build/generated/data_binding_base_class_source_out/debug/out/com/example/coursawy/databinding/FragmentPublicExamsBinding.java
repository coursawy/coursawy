...
public final class FragmentPublicExamsBinding implements ViewBinding {
  ...
  @NonNull
  public static FragmentPublicExamsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPublicExamsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_public__exams_, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPublicExamsBinding bind(@NonNull View rootView) {
