...
public final class ItemQuizExamWhiteBinding implements ViewBinding {
  @NonNull
  ...
  private ItemQuizExamWhiteBinding(@NonNull CardView rootView, @NonNull CardView cardview,
  ...
  @NonNull
  public static ItemQuizExamWhiteBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemQuizExamWhiteBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_quiz_exam_white, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemQuizExamWhiteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemQuizExamWhiteBinding((CardView) rootView, cardview, doctorName, passOrfail,
