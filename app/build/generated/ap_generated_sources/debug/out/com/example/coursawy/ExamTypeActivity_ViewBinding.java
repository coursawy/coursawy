...
public class ExamTypeActivity_ViewBinding implements Unbinder {
  private ExamTypeActivity target;

  @UiThread
  public ExamTypeActivity_ViewBinding(ExamTypeActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ExamTypeActivity_ViewBinding(ExamTypeActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ExamTypeActivity target = this.target;
