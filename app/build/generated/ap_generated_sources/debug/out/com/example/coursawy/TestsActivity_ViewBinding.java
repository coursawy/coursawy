...
public class TestsActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public TestsActivity_ViewBinding(TestsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public TestsActivity_ViewBinding(TestsActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TestsActivity target = this.target;
